...
urlpatterns = [
  ...
  path('increase-cart/<slug:slug>/', views.increase_item_in_cart, name='increase-cart'),
  path('decrease-cart/<slug:slug>/', views.decrease_item_in_cart, name='decrease-cart'),
]